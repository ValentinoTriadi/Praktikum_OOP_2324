...
public class Penyihir implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        ...
        System.out.println(self.getName() + ", memukul " + target.getName() + " dengan " + getTongkat());
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        ...
        if (manaTarget <= 40) {
            self.addMana(manaTarget);
        } else {
            self.addMana(40);
            manaTarget = 40;
        }
        target.reduceMana(manaTarget);
        System.out.println(self.getName() + " menyerap " + manaTarget + " mana dari " + target.getName());
